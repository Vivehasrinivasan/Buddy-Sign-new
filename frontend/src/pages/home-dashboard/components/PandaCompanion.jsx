...
import PandaScene from '../../../components/3d/PandaScene';
    ...
    <div className={`relative ${className}`}>
      ...
      <div className="relative bg-gradient-to-br from-primary/5 to-accent/5 rounded-2xl p-8 mb-6 overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] items-center">
            <div className="relative w-full h-[280px] md:h-[340px]">
              <PandaScene action={currentAction} />
              <div className="pointer-events-none absolute inset-x-4 bottom-4 flex flex-wrap items-center justify-between gap-2 text-xs font-caption text-muted-foreground/90">
                <span className="inline-flex items-center gap-1 rounded-full bg-white/30 px-3 py-1 backdrop-blur-sm">
                  <Icon name="Stars" size={14} className="text-primary" />
                  <span>Ultra-realistic panda</span>
                </span>
                <span className="inline-flex items-center gap-1 rounded-full bg-white/30 px-3 py-1 backdrop-blur-sm">
                  <Icon name="Activity" size={14} className="text-secondary" />
                  <span>Interactive motions</span>
                </span>
              </div>
            </div>
